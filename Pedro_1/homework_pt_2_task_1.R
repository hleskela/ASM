...
legend(x=12,y=13, inset=.05, cex = 1, c("Model"), lty=c(1,1), lwd=c(2,2), col=c("red"), bg="grey96")
...
plot(Yr,e,ylab="e²", main="Plot 2", sub="The error squared of the model vs manufacturing year")
# Superimposing the estimated variance
unique_years <- unique(Yr)
lines(unique_years,sigmaSquared, col='red', lwd=2)
